        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodParafa = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Simptome = table.Column<string>(type: "text", nullable: true),
                    Clinice = table.Column<string>(type: "text", nullable: true),
                    Paraclinice = table.Column<string>(type: "text", nullable: true),
                    Diagnostic = table.Column<string>(type: "text", nullable: true),
                    Recomandari = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalLetters_ConsultationSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TranscriptSegments_ConsultationSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ConsultationSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UploadedDocuments_ConsultationSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ConsultationSessions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalLetters_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UploadedDocuments_PatientId",
                table: "UploadedDocuments",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadedDocuments_SessionId",
                table: "UploadedDocuments",
                column: "SessionId");
        }
